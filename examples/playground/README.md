# RDF + MCP Playground - Interactive Semantic CLI Exploration

This playground demonstrates the integration of **clap-noun-verb's RDF layer** with **MCP (Model Context Protocol)** coordination for semantic CLI development.

## 🎮 Available Playgrounds

### 1. RDF Interactive Playground
**File**: `rdf_interactive_playground.rs`
**Run**: `cargo run --example rdf_interactive_playground`
...
**Output Highlights**:
- ✅ 5 commands → 72 RDF triples
- 🔍 Query services commands by noun
- 📊 Analyze guard usage frequency
- ✅ Validate all commands against SHACL shapes

### 2. Oxigraph SPARQL Playground
**File**: `rdf_oxigraph_sparql.rs`
**Run**: `cargo run --example rdf_oxigraph_sparql`

**Demonstrates**:
- Real SPARQL 1.1 queries using oxigraph store
...
**Results**:
- 5 total commands indexed
- 3 commands with state-change effects
- 5 required parameters identified
- 2 idempotent state-changing commands
- Guard frequency analysis (authenticated: 5, authorized: 3)
...
**Status**: ✅ Production-ready playground examples
