...
use clap_noun_verb::{
    app, noun, verb, Cli, CommandTree, CommandTreeBuilder, NounCommand, Registry, Result, VerbArgs,
};
...
fn main() -> Result<()> {
    ...
    let tree = CommandTree::from_builder(
        CommandTreeBuilder::new()
            ...
            .add_root_with_handler("version", "Show version information", |_args: &VerbArgs| {
